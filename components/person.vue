  ...
  <div class="flex flex-col gap-20 justify-between bg-versa-white text-versa-black rounded-xl mb-5 break-inside-avoid-column min-h-[216px] overflow-hidden">
    <div class="flex flex-row gap-2.5 justify-between p-10 pb-0">
      ...
      <div class="flex flex-col gap-2.5">
        ...
        <SocialLink v-if="props.linkedin" :link="props.linkedin" iconClasses="fa-brands fa-linkedin text-versa-black" />
        <SocialLink v-if="props.github" :link="props.github" iconClasses="fa-brands fa-github text-versa-black" />
        <SocialLink v-if="props.dribbble" :link="props.dribbble" iconClasses="fa-brands fa-dribbble text-versa-black" />
      </div>
    </div>
    <div class="after:bg-gradient-to-r relative after:content-[''] after:h-full after:w-40 after:absolute after:right-0 after:top-0 after:from-transparent after:to-versa-white after:pointer-events-none">
